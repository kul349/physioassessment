...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Update meta tags
    document.title =
      "Physiotherapy Assessment Tests Guide | PhysioTest - Patient Education";
    ...
    updateMetaTag(
      "description",
      "Understand physiotherapy assessment tests with our patient-friendly guides. Learn what your therapist does, videos, and what results mean for your recovery."
    );
    updateMetaTag(
      "keywords",
      "physiotherapy tests, assessment tests, physical therapy, patient education, injury recovery, test guides"
    );
    updateMetaTag(
      "og:title",
      "PhysioTest - Patient-Friendly Assessment Guides"
    );
    updateMetaTag(
      "og:description",
      "Clear, simple explanations of physiotherapy tests with videos and step-by-step guides"
    );
    ...
    updateMetaTag(
      "twitter:description",
      "Clear, simple explanations of physiotherapy tests"
    );
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Understand physiotherapy assessment tests with our patient-friendly guides. Learn what your therapist does, videos, and what results mean for your recovery."
        />
        <meta
          name="keywords"
          content="physiotherapy tests, assessment tests, physical therapy, patient education, injury recovery"
        />
        <link rel="canonical" href="https://yoursite.com" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="theme-color" content="#4f7661" />
      </Head>
