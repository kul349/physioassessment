    ...
    <>
      <div className="min-h-screen bg-[#F7F9F8] text-slate-900 font-sans selection:bg-emerald-100">
        ...
        <section className="relative py-20 md:py-32 overflow-hidden bg-white">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-8 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-500 font-serif italic">
                complicated
              </span>
            </h1>
        ...
        <section className="py-24 px-6 bg-slate-900">
          <div className="max-w-5xl mx-auto bg-linear-to-br from-emerald-600 to-teal-700 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-emerald-900/40">
